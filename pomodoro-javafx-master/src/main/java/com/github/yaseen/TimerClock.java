...
import com.github.yaseen.model.CountDownObserver;
import com.github.yaseen.model.TimeMode;
import javafx.application.Platform;
import javafx.scene.control.Label;
import javafx.scene.control.ProgressBar;

public class TimerClock implements CountDownObserver {
    private final TimerController controller;
    private final Label clockLabel;
    private final ProgressBar progressBar;
    private TimeMode mode;

    public TimerClock(TimerController controller, Label clockLabel, ProgressBar progressBar, TimeMode mode) {
